...
function Dashboard() {
  ...
  // Fetch user info when component mounts - only if no userInfo and not already loading
  useEffect(() => {
    // Only fetch if we don't have userInfo already and not currently loading
